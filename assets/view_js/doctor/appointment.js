...
$(document).ready(function() {
    table = $('#appointment_table').DataTable({
        "ajax": frontend_path + "doctor/display_all_appointment_details",
...
let camera_button = document.querySelector("#start-camera");
         ...
         click_button.addEventListener('click', function() {
               ...
               $("#newimg").attr('src', image_data_url);
                        $("#img").show();
                        var dataURL = canvas.toDataURL();
                        $('#click_file_name').val(dataURL);
                        // var patient_id_1 = $('#patient_id_1').val();
                        // $.ajax({
                        //     type: "POST",
                        //     url: frontend_path + "doctor/get_image_data",
                        //     data: {
                        //         imgBase64: dataURL,
