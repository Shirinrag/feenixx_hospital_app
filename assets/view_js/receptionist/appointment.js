    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            var surgery_details = data.surgery_details;
             ...
             $('#edit_id').val(info.id);
                $('#fk_patient_id').val(info.fk_patient_id);
                $('#fk_appointment_id').val(info.id);
                $('#update_appointment_id').val(info.id);
                $('#final_fk_appointment_id').val(info.id);
                $('#final_fk_patient_id').val(info.fk_patient_id);
                $('#advance_fk_patient_id').val(info.fk_patient_id);
                $('#advance_fk_appointment_id').val(info.id);
                $('#edit_fk_appointment_id').val(info.id);
                $('#edit_fk_appointment_id_1').val(info.id);
                $('#surgery_fk_appointment_id').val(info.id);
