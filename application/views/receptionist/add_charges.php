...
<body>
    ...
    <section class="section">
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Charges Form</h5>

              <!-- Vertical Form -->
              <?php echo form_open('receptionist/save_charges', array('id'=>'save_charges_form')) ?>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="charges_name" class="form-label required">Charges</label>
                    <input type="text" class="form-control input-text" id="charges_name" name="charges_name" placeholder="Enter Charges">
                    <span class="error_msg" id="charges_name_error"></span>
                  </div>
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Charges List</h5>
  ...
  <!-- Vendor JS Files -->
   ...
   <script type="text/javascript" src="<?=base_url()?>assets/view_js/receptionist/charges.js"></script>
